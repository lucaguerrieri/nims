function [rmse_varmat, forecast_mat, forecast_errors_mat] = calc_rmse_var_conditional(yobs, other_var_obs, out_of_sample_start_pos, end_sample_pos, forecast_horizon, varlag)
...
for pos_index = out_of_sample_start_pos:end_sample_pos
    ...
    this_other_var_obs = other_var_obs(:,1:pos_index-1); %factors
...
p10 = 0.000000000001*eye(size(bmatsmall,1));
    ...
    %[forecast_var] = var_out_of_sample_forecasts(f_var, var_data, varlag, n_other_var_obs, nothers, forecast_horizon);
