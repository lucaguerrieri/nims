function [rmse_mat, forecast_mat, forecast_errors_mat] = calc_rmse_multivariate_conditional(yobs, other_obs, out_of_sample_start_pos, end_sample_pos, forecast_horizon, reglag)
