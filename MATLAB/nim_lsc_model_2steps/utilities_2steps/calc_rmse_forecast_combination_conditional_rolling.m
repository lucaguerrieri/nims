function [rmse_mat, forecast_mat, forecast_errors_mat, insample_forecast_errors_mat] = calc_rmse_forecast_combination_conditional_rolling(yobs, other_obs, out_of_sample_start_pos, end_sample_pos, forecast_horizon, firstlag,lastlag)
...
for pos_index = out_of_sample_start_pos:end_sample_pos
    ...
    for this_macro_factor = 1:n_other_obs
        ...
        insample_forecast(this_macro_factor) = [1, this_yobs(1,end-1), this_other_obs(this_macro_factor,end-pos_vec) ]*...
                ols_coef;
