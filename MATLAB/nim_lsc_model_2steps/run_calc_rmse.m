%Update last few lines. calc_rmse.m still needs to be updated (it's in
%estimation utilities). This program was used to get the subsample
%estimates for the yield curve model.
...
for pos_index = out_of_sample_start_pos:end_sample_pos
    ...
    yobs = yobs(:,1:pos_index-1); %%Just the yields, no NIMs
...
[rmse_mlmat rmse_varmat rmse_nochangemat] = calc_rmse(opt_param_mat, out_of_sample_start_pos, end_sample_pos, yobs, factors, xi10_demeaned, p10, ntrain, tau, nfactors, nothers, forecast_horizon);
