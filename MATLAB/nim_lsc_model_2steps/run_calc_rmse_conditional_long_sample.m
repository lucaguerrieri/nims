...
[rmse_multivariate_mat1, forecast_multivariate_mat1, ...
 multivariate_errors_mat1] = calc_rmse_multivariate_conditional(nims(:,15:end), smoothed_factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, lag);

[rmse_multivariate_rolling_mat1, forecast_multivariate_rolling_mat1 ...
 multivariate_errors_rolling_mat1 insample_multivariate_errors_rolling_mat1] = calc_rmse_multivariate_conditional_rolling(nims(:,15:end), smoothed_factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, lag);


[rmse_forecast_combination_mat2, forecast_combination_mat2,...
    forecast_combination_errors_mat2] = calc_rmse_forecast_combination_conditional(nims(:,15:end),smoothed_factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, 1,4);
[rmse_forecast_combination_rolling_mat2, forecast_combination_rolling_mat2...
    forecast_combination_errors_rolling_mat2 insample_forecast_combination_errors_rolling_mat2] = calc_rmse_forecast_combination_conditional_rolling(nims(:,15:end),smoothed_factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, 1,4);


npc = 3;
[rmse_pc_mat1, forecast_pc_mat1,...
    pc_forecast_errors_mat] = calc_rmse_pc(nims(:,15:end), yields(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, npc);
[rmse_pc_rolling_mat1, forecast_pc_rolling_mat1,...
    pc_forecast_errors_rolling_mat, insample_pc_forecast_errors_rolling_mat] = calc_rmse_pc_rolling(nims(:,15:end), yields(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, npc);

npls = 3;
[rmse_pls_mat1, forecast_pls_mat1,...
    pls_forecast_errors_mat] = calc_rmse_pls_conditional(nims(:,15:end), yields(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, npls);
[rmse_pls_rolling_mat1, forecast_pls_rolling_mat1, ...
    pls_forecast_errors_rolling_mat, insample_pls_forecast_errors_rolling_mat] = ...
    calc_rmse_pls_conditional_rolling(nims(:,15:end), yields(:,15:end), ...
    out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, npls);



[rmse_forecast_combination_mat3, forecast_combination_mat3,...
    forecast_combination_errors_mat3] = calc_rmse_forecast_combination_conditional(nims(:,15:end),factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, 1,4);
[rmse_forecast_combination_rolling_mat3, forecast_combination_rolling_mat3,...
    forecast_combination_errors_rolling_mat3 insample_forecast_combination_errors_rolling_mat3] = calc_rmse_forecast_combination_conditional_rolling(nims(:,15:end),factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, 1,4);


varlag=4;
[rmse_var_mat1, forecast_var_mat1, var_forecast_errors_mat1] = calc_rmse_var_conditional(nims(:,15:end), smoothed_factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, varlag);
[rmse_var_rolling_mat1, forecast_var_rolling_mat1 ...
  var_forecast_errors_rolling_mat1 insample_var_forecast_errors_rolling_mat1] = calc_rmse_var_conditional_rolling(nims(:,15:end), smoothed_factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, varlag);



[rmse_var_mat2, forecast_var_mat2, var_forecast_errors_mat2] = calc_rmse_var_conditional(nims(:,15:end), factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, varlag);
[rmse_var_rolling_mat2, forecast_var_rolling_mat2,...
    var_forecast_errors_rolling_mat2 insample_var_forecast_errors_rolling_mat2] = calc_rmse_var_conditional_rolling(nims(:,15:end), factors(:,15:end), out_of_sample_start_pos-14, end_sample_pos-14, forecast_horizon, varlag);
...
error_type_list = char('forecast_combination_errors_rolling_mat1',...
               'multivariate_errors_rolling_mat1',...
               'forecast_combination_errors_rolling_mat2',...
...
error_type_list = char('forecast_combination_errors_mat1',...
               'multivariate_errors_mat1',...
               'forecast_combination_errors_mat2',...
...
test_results = run_rs_tests(multivariate_errors_rolling_mat1(:,1),...
                            forecast_errors_nochange_mat(:,1),...
                            insample_multivariate_errors_rolling_mat1,...
                            insample_forecast_errors_nochange_mat,...
                            qn,m);
test_table = [test_table; test_results];                       
                        
test_results = run_rs_tests(forecast_combination_errors_rolling_mat2(:,1),...
                            forecast_errors_nochange_mat(:,1),...
                            insample_forecast_combination_errors_rolling_mat2,...
                            insample_forecast_errors_nochange_mat,...
                            qn,m);
test_table = [test_table; test_results];  
