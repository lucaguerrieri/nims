function [rmse_mlmat rmse_varmat rmse_nochangemat ml_forecasts nochange_forecasts] = calc_rmse_conditional(opt_param_mat, out_of_sample_start_pos, end_sample_pos, yobs, factors, xi10, p10, ntrain, tau, nfactors, nothers, forecast_horizon, dates)
