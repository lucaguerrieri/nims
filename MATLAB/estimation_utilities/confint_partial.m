...
function [replication_forecast] = confint_partial(cofb,const,errmat,y,varlag,nreps,isconstant,iscontemp,yw,h,y_data,xi10,P10,q,ntrain,errpos)
...
%         end
    ...
    [logLikel,errcode,xi10History,...
     ...
     replication_forecast=xi1tHistory(1,:);
