...
function [likel q amatsmall bmatsmall endogsmall history smoothedhistory errhistory b0] = updatemod_full(params,paramlabels,modnam,parnam1,parnam2,observedlabels,upperbound,lowerbound,listdrop,ntrain)

% implements penalty function to ensure function evaluation is within
% desired bounds

% declare data matrix as global
global zdata endog_ errlist 
...
printflag = 0;
parseflag = 0;
[cofb,scof,endog_,xxxx,xxxxx,aimcode]=eggmodfunestim(modnam,parnam1,parnam2,parseflag,params,paramlabels);
...
amatsmall = amat; bmatsmall = bmat; endogsmall = endogs;
...
if nargout<3
        ...
        [likel,errcode,history,smoothedhistory,errhistory]= kalmanFilterSmoother(T,Z',zdata',b0,Q,bmatsmall,ntrain);
end
