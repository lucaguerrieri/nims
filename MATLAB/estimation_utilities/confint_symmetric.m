...
function [confint_lb confint_ub] = confint_symmetric(cofb,const,errmat,y,varlag,nreps,isconstant,iscontemp,yw,h,y_data,xi10,P10,q,ntrain,forecast_path)
...
std_vec = std(nim_mat);
confint_lb = forecast_path-2*std_vec;
confint_ub = forecast_path+2*std_vec;
